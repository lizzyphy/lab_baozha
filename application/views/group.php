   <div class="list_right">
    	<div id="right_head">
        	<p><a href="<?php echo base_url('index'); ?>">首页</a>&nbsp;>&nbsp;<a href="index.php"><?php echo $name['first_name'];?></a>&nbsp;>&nbsp;<a href="<?php echo base_url('group/type/?type=' . $type); ?>"><?php echo $name['second_name'];?></a></p>
