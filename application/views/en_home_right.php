     	...
     	<!-- 介绍和新闻 -->
            ...
            <img width="100%" height="5" src="<?php echo base_url('static/img/title.jpg')?>">
            <div id="photos">
            	 <a href="<?php echo base_url('en_article/?type=119')?>"><img width="20%" height="120" src="<?php echo base_url('static/img/p1.jpg')?>"></a>
                 <a href="<?php echo base_url('en_article/?type=119')?>"><img width="20%" height="120" src="<?php echo base_url('static/img/p2.jpg')?>"></a>
                 <a href="<?php echo base_url('en_article/?type=119')?>"><img  width="20%" height="120" src="<?php echo base_url('static/img/p3.jpg')?>"></a>
                 <a href="<?php echo base_url('en_article/?type=119')?>"><img  width="20%" height="120" src="<?php echo base_url('static/img/p4.jpg')?>"></a>
            </div>
            <div class="clear"></div>
      </div>
      <div class="clear"></div>
